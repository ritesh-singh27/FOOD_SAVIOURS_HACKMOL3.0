...
<body>
    ...
    <a href="login.php"><button type="button" class="btn btn-danger" id="login-button">Login</button></a>&nbsp
</nav>
</header>
   ...
   <center> <img src="photos/logo.png"><center>
    ...
    <div id="donatediv">
        <strong><a href="dono_nl.php"><button type="button" class="btn btn-danger">Donate</button></a></strong>
    </div>
